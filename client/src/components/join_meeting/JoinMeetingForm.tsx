...
export const JoinMeetingForm = () => {
  ...
  const { name, nameHandler, meetingIdRef, passcodeRef, onSubmitHandler } = useJoinMeetingForm();
  return (
    <div
      className={`w-96 pt-10 pb-16 px-8 rounded shadow ${
    ...
    >
      ...
      <form className="space-y-4" onSubmit={onSubmitHandler}>
        ...
        <CommonButton
          ...
          children="Save"
          type="submit"
          extraClass="w-full h-10 px-4 text-xs font-semi-bold "
        />
      </form>{" "}
    </div>
  );
